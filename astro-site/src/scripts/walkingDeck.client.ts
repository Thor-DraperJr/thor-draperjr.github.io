...
function initDeck(deck: WalkingDeckElement) {
    ...
    deck.addEventListener('presentation:enter', scheduleTextFitSettled);
    deck.addEventListener('presentation:slide', scheduleTextFitSettled);
    deck.addEventListener('presentation:exit', () => resetPretextElements(deck));
}
