...
excerpt: "Infrastructure as Code is going to matter more over time, so I used some downtime to learn it properly. This is the walkthrough from definition to a working deployment."
draft: false
---
...
![typing arm in vs code](/assets/images/posts/2021-09-01-iac/6-pipeline.png)

After pressing enter you'll have a json file created with templated information.

![Arm Template prefilled](/assets/images/posts/2021-09-01-iac/7-pipeline.png)
...
![resource list](/assets/images/posts/2021-09-01-iac/8-pipeline.png)
...
![azure deploy w/ resource group](/assets/images/posts/2021-09-01-iac/1-pipeline.png)
...
![azure portal resource group deployment](/assets/images/posts/2021-09-01-iac/2-pipeline.png)
...
![adding storage sku parameters](/assets/images/posts/2021-09-01-iac/3-pipeline.png)
...
![storage name is also a prameter](/assets/images/posts/2021-09-01-iac/4-pipeline.png)
...
![adding parameters azure deploy](/assets/images/posts/2021-09-01-iac/5-pipeline.png)
...
![adding parameters azure deploy](/assets/images/posts/2021-09-01-iac/13-pipeline.png)
...
![creating the service principal](/assets/images/posts/2021-09-01-iac/9-pipeline.png)
...
![adding azure secret credential value](/assets/images/posts/2021-09-01-iac/10-pipeline.png)
...
![Actions to Set up a workflow yourself](/assets/images/posts/2021-09-01-iac/11-pipeline.png)
