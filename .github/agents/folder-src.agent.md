...
---
name: folder-src
description: "Review ownership, conventions, and behavior controlled by src/."
...
Ground every delegated review in `src/` and the code, tests, configuration, or documentation that consumes it.
If `src/` is absent, report that fact and assess whether the repository needs the scope. Do not create the folder only to satisfy this agent structure.
