...
1. Read the shared repository mission in `.github/objectives.md` and the current `.github/insights/voice-publish-editor.md` before starting.
...
4. Overwrite `.github/insights/voice-publish-editor.md` with the current verified learning before finishing.
